  ...
  return (
    <div className="grid min-h-[calc(100vh-4rem)] place-items-center bg-slate-50 px-4 py-10">
      <div className="w-full max-w-md rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
        <div>
          <p className="text-sm font-medium text-slate-500">Start self-hosted analytics</p>
          <h1 className="mt-2 text-2xl font-semibold tracking-tight text-slate-950">Create your account</h1>
